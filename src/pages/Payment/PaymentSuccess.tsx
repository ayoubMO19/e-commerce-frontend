    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] px-4">
            <div className="relative mb-8">
                <div className="absolute inset-0 bg-green-500 opacity-20 blur-2xl rounded-full animate-pulse"></div>
                <div className="relative bg-white border border-zinc-100 p-6 rounded-[32px] shadow-sm">
                    <CheckCircle2 size={48} className="text-green-600 stroke-[1.5px]" />
                </div>
            </div>
            <div className="text-center space-y-3">
                ...
                <p className="text-zinc-400 text-[10px] md:text-xs font-black uppercase tracking-[0.2em]">
                    Gracias por tu compra en MOTORPART.
                </p>
            </div>
            ...
            <div className="mt-16 flex items-center gap-4 opacity-20">
                ...
                <span className="text-[8px] font-black uppercase tracking-[4px]">MOTORPART</span>
                <div className="h-[1px] w-12 bg-zinc-400"></div>
            </div>
        </div>
    );
